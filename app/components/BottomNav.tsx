...
export function BottomNav() {
  ...
  return (
    <div className="fixed bottom-0 left-1/2 -translate-x-1/2 w-full max-w-app bg-background [filter:drop-shadow(4px_0px_8px_rgba(163,163,163,0.3))] flex items-center justify-between pb-7 pt-4 px-[90px] rounded-tl-sheet rounded-tr-sheet z-50">
